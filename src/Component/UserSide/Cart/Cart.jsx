...
function Cart() {
 ...
 const Checkout=async()=>{
  ...
  console.log(Details)
  if(Details){
  const Order=await axios.post('https://my-web-qp94.onrender.com/user/Checkout',{
...
const {amount,key,Checkout}=Order.data;
  if(Order.data.operation==="True"){
    var options = {
      ...
      const  Data= await axios.post("https://my-web-qp94.onrender.com/user/paymentVeriFication",{
