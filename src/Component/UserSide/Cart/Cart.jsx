...
function Cart() {
 ...
 const Checkout=async()=>{
  ...
  console.log(Details)
  if(Details){
  const Order=await axios.post('https://ecommerce-production-a1ff.up.railway.app/user/Checkout',{
...
const {amount,key,Checkout}=Order.data;
  if(Order.data.operation==="True"){
    var options = {
      ...
      const  Data= await axios.post("https://ecommerce-production-a1ff.up.railway.app/user/paymentVeriFication",{
