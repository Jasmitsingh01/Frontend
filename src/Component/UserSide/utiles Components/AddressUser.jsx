...
function AddressUser() {
  ...
  useEffect(() => {
    ...
    const Data = async () => {
      const response = await axios.get(
        `https://ecommerce-production-c6bb.up.railway.app/user/GetDetalis/${Token}`
      );
  ...
  const SaveDetails = async (e) => {
    ...
    const response = await axios.post("https://ecommerce-production-c6bb.up.railway.app/user/SaveData", {
      token: Token,
